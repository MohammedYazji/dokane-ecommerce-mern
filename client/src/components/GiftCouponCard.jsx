  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <motion.button
          type="button"
          className="flex w-full items-center justify-center rounded-lg bg-dark px-5 py-2.5 text-sm font-medium text-white hover:bg-light focus:outline-none focus:ring-4 focus:ring-amber-300"
